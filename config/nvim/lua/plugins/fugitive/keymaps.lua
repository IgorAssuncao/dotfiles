...
local mult = require("base.keymaps").Keybind.mult
...
keybind { keys = "<leader>gPP", cmd = function() vim.cmd { cmd = "Git", args = { "pull" } } end,
  opts = { desc = "[G]it [P]ull", remap = true } }
keybind { keys = "<leader>gPR", function() vim.cmd { cmd = "echo", args = { '"pull --rebase"' } } end,
  opts = { desc = "[G]it [P]ull [R]ebase", remap = true } }
